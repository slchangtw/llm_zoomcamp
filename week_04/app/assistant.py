...
ELASTIC_URL = os.getenv("ES_URL", "http://localhost:9200")
...
def evaluate_relevance(question, answer, model_choice):
    prompt_template = """
    ...
    evaluation, tokens, _ = llm(prompt, model_choice)
